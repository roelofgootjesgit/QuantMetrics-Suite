...
class TestBBMidlineSimulator:
    ...
    def test_long_hits_midline_on_intrabar_high_touch(self):
        n = 20
        dates = pd.date_range("2024-01-01", periods=n, freq="15min", tz="UTC")
        ...
        res = simulate_bb_midline_trade(
            df, 5, "LONG", mid=mid, atr_arr=atr, sl_atr_mult=10.0, time_exit_bars=5
        )
    ...
    def test_short_hits_midline_on_intrabar_low_touch(self):
        n = 20
        dates = pd.date_range("2024-01-01", periods=n, freq="15min", tz="UTC")
        ...
        res = simulate_bb_midline_trade(
            df, 5, "SHORT", mid=mid, atr_arr=atr, sl_atr_mult=10.0, time_exit_bars=5
        )
