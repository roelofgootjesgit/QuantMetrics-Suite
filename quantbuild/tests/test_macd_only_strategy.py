...
from src.quantbuild.strategies import macd_only as macd_only_module
...
class TestMacdOnly:
    ...
    def test_collect_entries_filters_opposite_direction_clusters(self, monkeypatch):
        ...
        bear_raw = pd.Series([False, False, False, True, False, False, False, False], index=df.index)
        ...
        monkeypatch.setattr(macd_only_module, "compute_atr", lambda data, period=14: pd.Series(0.01, index=data.index))
