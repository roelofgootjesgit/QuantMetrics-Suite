...
def collect_macd_entry_signals(
    ...
    independent_raw = apply_independence_to_signals(bull_raw | bear_raw, data, atr_series, indep_cfg)
    bull_ind = bull_raw & independent_raw
    bear_ind = bear_raw & independent_raw
